...
public class Service {
    ...
    public static double multiplication(String numero1, String numero2){
        if (!NumberUtils.isNumeric(numero1) || !NumberUtils.isNumeric(numero2)) throw new ResourceNotFoundException("Please,set numeric value!!");
    ...
    public static double squareRoot(String numero1){
        if (!NumberUtils.isNumeric(numero1)) throw new ResourceNotFoundException("Please,set numeric value!!");
